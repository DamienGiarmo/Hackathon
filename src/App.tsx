        ...
        <div className="max-w-4xl mx-auto">
          <section className="text-center py-16">
            <div className="bg-red-50 rounded-lg p-4 mb-8 inline-flex items-center gap-2">
              ...
              <span className="text-red-700 font-medium">68% des espèces sauvages ont disparu depuis 1970</span>
            </div>
            ...
            <p className="text-xl text-emerald-700 mb-8">
              La France métropolitaine abrite 180 000 espèces, soit 10% de la biodiversité mondiale.
              Chaque espèce compte, chaque écosystème est précieux.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
              <div className="bg-white rounded-xl p-6 shadow-lg transform hover:scale-105 transition">
                <Bird className="h-12 w-12 text-emerald-600 mx-auto mb-4" />
                <h3 className="text-lg font-semibold mb-2">Faune</h3>
                <p className="text-gray-600">1 million d'espèces menacées d'extinction d'ici 2050</p>
                <p className="text-sm text-red-600 mt-2">-30% des populations depuis 1990</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg transform hover:scale-105 transition">
                ...
                <p className="text-sm text-red-600 mt-2">15% déjà disparues localement</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-lg transform hover:scale-105 transition">
                ...
                <p className="text-sm text-red-600 mt-2">-2.5% de biomasse chaque année</p>
              </div>
            </div>
          </section>
          ...
          {showActions && (
            <section className="bg-white rounded-2xl p-8 shadow-xl mb-16">
              <h2 className="text-2xl font-semibold mb-6 text-emerald-800">5 Actions pour Protéger la Biodiversité</h2>
              <div className="grid gap-4">
                {actions.map((action, index) => (
                  <div key={index} className="flex items-center gap-4 p-4 bg-emerald-50 rounded-lg hover:bg-emerald-100 transition">
          ...
          <section className="py-16 text-center">
            <div className="bg-emerald-800 text-white rounded-2xl p-8 md:p-12 transform hover:scale-[1.02] transition">
              ...
              <p className="text-xl text-emerald-100 max-w-2xl mx-auto mb-6">
                La protection de la biodiversité nécessite une action immédiate. D'ici 2030, nous devons protéger 30% des terres et des mers.
              </p>
          ...
          <section className="grid md:grid-cols-2 gap-8 py-16">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h3 className="text-xl font-semibold mb-4 text-emerald-800">Impact Économique</h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-600">•</span>
                  <p>44 000 milliards € de valeur économique dépendent de la nature</p>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-600">•</span>
                  <p>Les insectes pollinisateurs représentent 153 milliards € par an</p>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-emerald-600">•</span>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <h3 className="text-xl font-semibold mb-4 text-emerald-800">Solutions Naturelles</h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-2">
                  <span className="text-emerald-600">•</span>
